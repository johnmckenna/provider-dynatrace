...
PROJECT_REPO ?= github.com/johnmckenna/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 1.68.1
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-dynatrace_v$(TERRAFORM_PROVIDER_VERSION)_x5
