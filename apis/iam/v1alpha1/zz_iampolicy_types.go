...
type IAMPolicyInitParameters struct {
	...
	// uuid>) in case the policy should be applied to all environments of this account. The prefix urn:dtaccount: MUST be omitted here.
	...
	// (String, Deprecated) The ID of the environment (https://.live.dynatrace.com) if the policy should be applied to a specific environment
...
type IAMPolicyObservation struct {
	...
	// (String) The ID of this resource is a concatenation of multiple pieces of information (policy UUID, accountID, environmentID, ...). There are use cases where you JUST need the UUID of the Policy, though
...
// IAMPolicy is the Schema for the IAMPolicys API. The resource
