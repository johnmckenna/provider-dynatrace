...
func (tr *IAMGroup) GetObservation() (map[string]any, error) {
...
func (tr *IAMGroup) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this IAMGroup
func (tr *IAMGroup) GetID() string {
...
func (tr *IAMGroup) GetParameters() (map[string]any, error) {
...
func (tr *IAMGroup) SetParameters(params map[string]any) error {
...
// GetInitParameters of this IAMGroup
func (tr *IAMGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IAMGroup
func (tr *IAMGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
