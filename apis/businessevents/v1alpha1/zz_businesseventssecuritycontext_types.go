...
type BusinessEventsSecurityContextInitParameters struct {
...
type BusinessEventsSecurityContextObservation struct {
...
type BusinessEventsSecurityContextParameters struct {
...
// BusinessEventsSecurityContextSpec defines the desired state of BusinessEventsSecurityContext
type BusinessEventsSecurityContextSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BusinessEventsSecurityContextParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BusinessEventsSecurityContextInitParameters `json:"initProvider,omitempty"`
}

// BusinessEventsSecurityContextStatus defines the observed state of BusinessEventsSecurityContext.
type BusinessEventsSecurityContextStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BusinessEventsSecurityContextObservation `json:"atProvider,omitempty"`
}
...
// BusinessEventsSecurityContext is the Schema for the BusinessEventsSecurityContexts API. The resource
...
type BusinessEventsSecurityContext struct {
	...
	Spec   BusinessEventsSecurityContextSpec   `json:"spec"`
	Status BusinessEventsSecurityContextStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BusinessEventsSecurityContextList contains a list of BusinessEventsSecurityContexts
type BusinessEventsSecurityContextList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BusinessEventsSecurityContext `json:"items"`
}

// Repository type metadata.
var (
	BusinessEventsSecurityContext_Kind             = "BusinessEventsSecurityContext"
	BusinessEventsSecurityContext_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BusinessEventsSecurityContext_Kind}.String()
	BusinessEventsSecurityContext_KindAPIVersion   = BusinessEventsSecurityContext_Kind + "." + CRDGroupVersion.String()
	BusinessEventsSecurityContext_GroupVersionKind = CRDGroupVersion.WithKind(BusinessEventsSecurityContext_Kind)
)

func init() {
	SchemeBuilder.Register(&BusinessEventsSecurityContext{}, &BusinessEventsSecurityContextList{})
}
