...
type MetricEventsEventTemplateInitParameters struct {
...
type MetricEventsEventTemplateObservation struct {
...
type MetricEventsEventTemplateParameters struct {
...
type MetricEventsInitParameters struct {
	...
	// Event template
	EventTemplate []MetricEventsEventTemplateInitParameters `json:"eventTemplate,omitempty" tf:"event_template,omitempty"`
...
type MetricEventsObservation struct {
	...
	// (Block List, Min: 1, Max: 1) Event template (see below for nested schema)
	// Event template
	EventTemplate []MetricEventsEventTemplateObservation `json:"eventTemplate,omitempty" tf:"event_template,omitempty"`
...
type MetricEventsParameters struct {
	...
	// Event template
	// +kubebuilder:validation:Optional
	EventTemplate []MetricEventsEventTemplateParameters `json:"eventTemplate,omitempty" tf:"event_template,omitempty"`
...
// MetricEventsSpec defines the desired state of MetricEvents
type MetricEventsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MetricEventsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MetricEventsInitParameters `json:"initProvider,omitempty"`
}

// MetricEventsStatus defines the observed state of MetricEvents.
type MetricEventsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MetricEventsObservation `json:"atProvider,omitempty"`
}
...
// MetricEvents is the Schema for the MetricEventss API. The resource
...
type MetricEvents struct {
	...
	Spec   MetricEventsSpec   `json:"spec"`
	Status MetricEventsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MetricEventsList contains a list of MetricEventss
type MetricEventsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MetricEvents `json:"items"`
}

// Repository type metadata.
var (
	MetricEvents_Kind             = "MetricEvents"
	MetricEvents_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MetricEvents_Kind}.String()
	MetricEvents_KindAPIVersion   = MetricEvents_Kind + "." + CRDGroupVersion.String()
	MetricEvents_GroupVersionKind = CRDGroupVersion.WithKind(MetricEvents_Kind)
)

func init() {
	SchemeBuilder.Register(&MetricEvents{}, &MetricEventsList{})
}
