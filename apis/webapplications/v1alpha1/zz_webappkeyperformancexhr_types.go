...
type WebAppKeyPerformanceXhrFallbackThresholdsInitParameters struct {
...
type WebAppKeyPerformanceXhrFallbackThresholdsObservation struct {
...
type WebAppKeyPerformanceXhrFallbackThresholdsParameters struct {
...
type WebAppKeyPerformanceXhrInitParameters struct {
	...
	FallbackThresholds []WebAppKeyPerformanceXhrFallbackThresholdsInitParameters `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`

	// (String) Possible Values: RESPONSE_END, RESPONSE_START, USER_ACTION_DURATION, VISUALLY_COMPLETE
	...
	Thresholds []WebAppKeyPerformanceXhrThresholdsInitParameters `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type WebAppKeyPerformanceXhrObservation struct {

	// (Block List, Max: 1) If the selected key performance metric is not detected, the User action duration metric is used instead. (see below for nested schema)
	// If the selected key performance metric is not detected, the **User action duration** metric is used instead.
	FallbackThresholds []WebAppKeyPerformanceXhrFallbackThresholdsObservation `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`
	...
	// (Block List, Min: 1, Max: 1) Set the Tolerating and Frustrated performance thresholds for this action type. (see below for nested schema)
	// Set the Tolerating and Frustrated performance thresholds for this action type.
	Thresholds []WebAppKeyPerformanceXhrThresholdsObservation `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type WebAppKeyPerformanceXhrParameters struct {

	// (Block List, Max: 1) If the selected key performance metric is not detected, the User action duration metric is used instead. (see below for nested schema)
	// If the selected key performance metric is not detected, the **User action duration** metric is used instead.
	// +kubebuilder:validation:Optional
	FallbackThresholds []WebAppKeyPerformanceXhrFallbackThresholdsParameters `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`
	...
	// Set the Tolerating and Frustrated performance thresholds for this action type.
	// +kubebuilder:validation:Optional
	Thresholds []WebAppKeyPerformanceXhrThresholdsParameters `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type WebAppKeyPerformanceXhrThresholdsInitParameters struct {
...
type WebAppKeyPerformanceXhrThresholdsObservation struct {
...
type WebAppKeyPerformanceXhrThresholdsParameters struct {
...
// WebAppKeyPerformanceXhrSpec defines the desired state of WebAppKeyPerformanceXhr
type WebAppKeyPerformanceXhrSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     WebAppKeyPerformanceXhrParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider WebAppKeyPerformanceXhrInitParameters `json:"initProvider,omitempty"`
}

// WebAppKeyPerformanceXhrStatus defines the observed state of WebAppKeyPerformanceXhr.
type WebAppKeyPerformanceXhrStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        WebAppKeyPerformanceXhrObservation `json:"atProvider,omitempty"`
}
...
// WebAppKeyPerformanceXhr is the Schema for the WebAppKeyPerformanceXhrs API. The resource
...
type WebAppKeyPerformanceXhr struct {
	...
	Spec   WebAppKeyPerformanceXhrSpec   `json:"spec"`
	Status WebAppKeyPerformanceXhrStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// WebAppKeyPerformanceXhrList contains a list of WebAppKeyPerformanceXhrs
type WebAppKeyPerformanceXhrList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []WebAppKeyPerformanceXhr `json:"items"`
}

// Repository type metadata.
var (
	WebAppKeyPerformanceXhr_Kind             = "WebAppKeyPerformanceXhr"
	WebAppKeyPerformanceXhr_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: WebAppKeyPerformanceXhr_Kind}.String()
	WebAppKeyPerformanceXhr_KindAPIVersion   = WebAppKeyPerformanceXhr_Kind + "." + CRDGroupVersion.String()
	WebAppKeyPerformanceXhr_GroupVersionKind = CRDGroupVersion.WithKind(WebAppKeyPerformanceXhr_Kind)
)

func init() {
	SchemeBuilder.Register(&WebAppKeyPerformanceXhr{}, &WebAppKeyPerformanceXhrList{})
}
