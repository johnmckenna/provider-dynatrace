...
type ConditionComparisonInitParameters struct {
...
type ConditionComparisonObservation struct {
...
type ConditionComparisonParameters struct {
...
type ConditionServiceTypeInitParameters struct {
...
type ConditionServiceTypeObservation struct {
...
type ConditionServiceTypeParameters struct {
...
type ConditionStringInitParameters struct {
...
type ConditionStringObservation struct {
...
type ConditionStringParameters struct {
...
type ConditionTagInitParameters struct {
...
type ConditionTagObservation struct {
...
type ConditionTagParameters struct {
...
type ServiceNamingConditionsConditionInitParameters struct {
	...
	// A comparison that's yet unknown to the provider. Operator and Value need to be encoded using the 'unknowns' property.
	Comparison []ConditionComparisonInitParameters `json:"comparison,omitempty" tf:"comparison,omitempty"`
	...
	ServiceType []ConditionServiceTypeInitParameters `json:"serviceType,omitempty" tf:"service_type,omitempty"`
	...
	String []ConditionStringInitParameters `json:"string,omitempty" tf:"string,omitempty"`
	...
	Tag []ConditionTagInitParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type ServiceNamingConditionsConditionObservation struct {
	...
	// (Block List) A comparison that's yet unknown to the provider. Operator and Value need to be encoded using the 'unknowns' property. (see below for nested schema)
	// A comparison that's yet unknown to the provider. Operator and Value need to be encoded using the 'unknowns' property.
	Comparison []ConditionComparisonObservation `json:"comparison,omitempty" tf:"comparison,omitempty"`
	...
	// (Block List) Comparison for SERVICE_TYPE attributes (see below for nested schema)
	// Comparison for `SERVICE_TYPE` attributes
	ServiceType []ConditionServiceTypeObservation `json:"serviceType,omitempty" tf:"service_type,omitempty"`
	...
	// (Block List) Comparison for STRING attributes (see below for nested schema)
	// Comparison for `STRING` attributes
	String []ConditionStringObservation `json:"string,omitempty" tf:"string,omitempty"`
	...
	// (Block List) Comparison for TAG attributes (see below for nested schema)
	// Comparison for `TAG` attributes
	Tag []ConditionTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type ServiceNamingConditionsConditionParameters struct {
	...
	// A comparison that's yet unknown to the provider. Operator and Value need to be encoded using the 'unknowns' property.
	// +kubebuilder:validation:Optional
	Comparison []ConditionComparisonParameters `json:"comparison,omitempty" tf:"comparison,omitempty"`
	...
	// Comparison for `SERVICE_TYPE` attributes
	// +kubebuilder:validation:Optional
	ServiceType []ConditionServiceTypeParameters `json:"serviceType,omitempty" tf:"service_type,omitempty"`
	...
	// Comparison for `STRING` attributes
	// +kubebuilder:validation:Optional
	String []ConditionStringParameters `json:"string,omitempty" tf:"string,omitempty"`
	...
	// Comparison for `TAG` attributes
	// +kubebuilder:validation:Optional
	Tag []ConditionTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type ServiceNamingConditionsInitParameters struct {

	// (Block List) A conditions for the metric usage (see below for nested schema)
	// A conditions for the metric usage
	Condition []ServiceNamingConditionsConditionInitParameters `json:"condition,omitempty" tf:"condition,omitempty"`
}

type ServiceNamingConditionsObservation struct {

	// (Block List) A conditions for the metric usage (see below for nested schema)
	// A conditions for the metric usage
	Condition []ServiceNamingConditionsConditionObservation `json:"condition,omitempty" tf:"condition,omitempty"`
}

type ServiceNamingConditionsParameters struct {

	// (Block List) A conditions for the metric usage (see below for nested schema)
	// A conditions for the metric usage
	// +kubebuilder:validation:Optional
	Condition []ServiceNamingConditionsConditionParameters `json:"condition,omitempty" tf:"condition,omitempty"`
}

type ServiceNamingInitParameters struct {
	...
	Conditions []ServiceNamingConditionsInitParameters `json:"conditions,omitempty" tf:"conditions,omitempty"`
...
type ServiceNamingObservation struct {

	// (Block List) A list of matching conditions of the rule.  The rule applies only if all conditions are fulfilled (see below for nested schema)
	// A list of matching conditions of the rule.  The rule applies only if **all** conditions are fulfilled
	Conditions []ServiceNamingConditionsObservation `json:"conditions,omitempty" tf:"conditions,omitempty"`
...
type ServiceNamingParameters struct {

	// (Block List) A list of matching conditions of the rule.  The rule applies only if all conditions are fulfilled (see below for nested schema)
	// A list of matching conditions of the rule.  The rule applies only if **all** conditions are fulfilled
	// +kubebuilder:validation:Optional
	Conditions []ServiceNamingConditionsParameters `json:"conditions,omitempty" tf:"conditions,omitempty"`
...
// ServiceNamingSpec defines the desired state of ServiceNaming
type ServiceNamingSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ServiceNamingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ServiceNamingInitParameters `json:"initProvider,omitempty"`
}

// ServiceNamingStatus defines the observed state of ServiceNaming.
type ServiceNamingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServiceNamingObservation `json:"atProvider,omitempty"`
}
...
// ServiceNaming is the Schema for the ServiceNamings API. The resource
...
type ServiceNaming struct {
	...
	Spec   ServiceNamingSpec   `json:"spec"`
	Status ServiceNamingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceNamingList contains a list of ServiceNamings
type ServiceNamingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServiceNaming `json:"items"`
}

// Repository type metadata.
var (
	ServiceNaming_Kind             = "ServiceNaming"
	ServiceNaming_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceNaming_Kind}.String()
	ServiceNaming_KindAPIVersion   = ServiceNaming_Kind + "." + CRDGroupVersion.String()
	ServiceNaming_GroupVersionKind = CRDGroupVersion.WithKind(ServiceNaming_Kind)
)

func init() {
	SchemeBuilder.Register(&ServiceNaming{}, &ServiceNamingList{})
}
