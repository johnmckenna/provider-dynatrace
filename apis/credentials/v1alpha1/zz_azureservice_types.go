...
type AzureServiceInitParameters struct {
	...
	Metric []AzureServiceMetricInitParameters `json:"metric,omitempty" tf:"metric,omitempty"`
...
type AzureServiceMetricInitParameters struct {
...
type AzureServiceMetricObservation struct {
...
type AzureServiceMetricParameters struct {
...
type AzureServiceObservation struct {
	...
	// empty plan, until all of the recommended metrics are present within your configuration. For services considered built-in by Dynatrace any metrics specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services. (see below for nested schema)
	// A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended metrics to be configured for that service. This usually results in a non-empty plan, until all of the recommended metrics are present within your configuration. For services considered `built-in` by Dynatrace any metrics specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services.
	Metric []AzureServiceMetricObservation `json:"metric,omitempty" tf:"metric,omitempty"`
...
type AzureServiceParameters struct {
	...
	// A list of metrics to be monitored for this service. Depending on the service Dynatrace insists on a set of recommended metrics to be configured for that service. This usually results in a non-empty plan, until all of the recommended metrics are present within your configuration. For services considered `built-in` by Dynatrace any metrics specified here will be ignored - Dynatrace enforces a fixed set of metrics for these services.
	// +kubebuilder:validation:Optional
	Metric []AzureServiceMetricParameters `json:"metric,omitempty" tf:"metric,omitempty"`
...
// AzureServiceSpec defines the desired state of AzureService
type AzureServiceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AzureServiceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AzureServiceInitParameters `json:"initProvider,omitempty"`
}

// AzureServiceStatus defines the observed state of AzureService.
type AzureServiceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AzureServiceObservation `json:"atProvider,omitempty"`
}
...
// AzureService is the Schema for the AzureServices API. The resource
...
type AzureService struct {
	...
	Spec   AzureServiceSpec   `json:"spec"`
	Status AzureServiceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AzureServiceList contains a list of AzureServices
type AzureServiceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AzureService `json:"items"`
}

// Repository type metadata.
var (
	AzureService_Kind             = "AzureService"
	AzureService_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AzureService_Kind}.String()
	AzureService_KindAPIVersion   = AzureService_Kind + "." + CRDGroupVersion.String()
	AzureService_GroupVersionKind = CRDGroupVersion.WithKind(AzureService_Kind)
)

func init() {
	SchemeBuilder.Register(&AzureService{}, &AzureServiceList{})
}
