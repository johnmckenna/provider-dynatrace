...
type ApplicationTypeComparisonInitParameters struct {
	...
	// (String) The type of Dynatrace entities the management zone can be applied to
...
type AutotagInitParameters struct {
	...
	EntitySelectorBasedRule []EntitySelectorBasedRuleInitParameters `json:"entitySelectorBasedRule,omitempty" tf:"entity_selector_based_rule,omitempty"`

	// tag, which is applied to entities.  Additionally you can specify a valueFormat in the tag rule. In that case the tag is used in the name:valueFormat format.  For example you can extend the Infrastructure tag to Infrastructure:Windows and Infrastructure:Linux.
	...
	Rules []AutotagRulesInitParameters `json:"rules,omitempty" tf:"rules,omitempty"`
...
type AutotagObservation struct {
	...
	// selector based rules for management zone usage. If several rules are specified, the or logic applies (see below for nested schema)
	// A list of entity-selector based rules for management zone usage. If several rules are specified, the `or` logic applies
	EntitySelectorBasedRule []EntitySelectorBasedRuleObservation `json:"entitySelectorBasedRule,omitempty" tf:"entity_selector_based_rule,omitempty"`
	...
	// (Block Set) A list of rules for management zone usage.  Each rule is evaluated independently of all other rules (see below for nested schema)
	// A list of rules for management zone usage.  Each rule is evaluated independently of all other rules
	Rules []AutotagRulesObservation `json:"rules,omitempty" tf:"rules,omitempty"`
...
type AutotagParameters struct {
	...
	// A list of rules for management zone usage.  Each rule is evaluated independently of all other rules
	// +kubebuilder:validation:Optional
	Rules []AutotagRulesParameters `json:"rules,omitempty" tf:"rules,omitempty"`
...
type AutotagRulesInitParameters struct {

	// (Block Set) A list of matching rules for the management zone. The management zone applies only if all conditions are fulfilled (see below for nested schema)
	...
	// (String) Changes applied to the value after applying the value format. Possible values are LEAVE_TEXT_AS_IS, TO_LOWER_CASE and TO_UPPER_CASE. Default is LEAVE_TEXT_AS_IS
	...
	// (List of String) How to apply the management zone to underlying entities:
	...
	// selector-based auto-tag. If specified, the tag is used in the name:valueFormat format.
...
type AutotagRulesObservation struct {
...
type AutotagRulesParameters struct {
...
type EntitySelectorBasedRuleInitParameters struct {
...
type AutotagSpec struct {
	...
	// autoscaler.
	InitProvider AutotagInitParameters `json:"initProvider,omitempty"`
}
...
// Autotag is the Schema for the Autotags API. The resource
...
// AutotagList contains a list of Autotags
...
var (
	Autotag_Kind             = "Autotag"
	Autotag_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Autotag_Kind}.String()
	Autotag_KindAPIVersion   = Autotag_Kind + "." + CRDGroupVersion.String()
	Autotag_GroupVersionKind = CRDGroupVersion.WithKind(Autotag_Kind)
)
