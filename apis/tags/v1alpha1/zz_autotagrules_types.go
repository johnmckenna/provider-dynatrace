...
// AutotagRulesSpec defines the desired state of AutotagRules
type AutotagRulesSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AutotagRulesParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AutotagRulesInitParameters `json:"initProvider,omitempty"`
}

// AutotagRulesStatus defines the observed state of AutotagRules.
type AutotagRulesStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AutotagRulesObservation `json:"atProvider,omitempty"`
}
...
// AutotagRules is the Schema for the AutotagRuless API. The resource
...
type AutotagRules struct {
	...
	Spec   AutotagRulesSpec   `json:"spec"`
	Status AutotagRulesStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AutotagRulesList contains a list of AutotagRuless
type AutotagRulesList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AutotagRules `json:"items"`
}

// Repository type metadata.
var (
	AutotagRules_Kind             = "AutotagRules"
	AutotagRules_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AutotagRules_Kind}.String()
	AutotagRules_KindAPIVersion   = AutotagRules_Kind + "." + CRDGroupVersion.String()
	AutotagRules_GroupVersionKind = CRDGroupVersion.WithKind(AutotagRules_Kind)
)

func init() {
	SchemeBuilder.Register(&AutotagRules{}, &AutotagRulesList{})
}
