...
type AutotagV2InitParameters struct {
	...
	// Rules
	Rules []AutotagV2RulesInitParameters `json:"rules,omitempty" tf:"rules,omitempty"`

	// (Boolean) If true this resource will not
...
type AutotagV2Observation struct {
	...
	// (Block List, Max: 1) Rules (see below for nested schema)
	// Rules
	Rules []AutotagV2RulesObservation `json:"rules,omitempty" tf:"rules,omitempty"`
...
type AutotagV2Parameters struct {
	...
	// Rules
	// +kubebuilder:validation:Optional
	Rules []AutotagV2RulesParameters `json:"rules,omitempty" tf:"rules,omitempty"`
...
type RulesRuleInitParameters struct {
	...
	// (String) The documentation of the entity selector can be found here.
...
// AutotagV2Spec defines the desired state of AutotagV2
type AutotagV2Spec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AutotagV2Parameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AutotagV2InitParameters `json:"initProvider,omitempty"`
}

// AutotagV2Status defines the observed state of AutotagV2.
type AutotagV2Status struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AutotagV2Observation `json:"atProvider,omitempty"`
}
...
// AutotagV2 is the Schema for the AutotagV2s API. The resource
...
type AutotagV2 struct {
	...
	Spec   AutotagV2Spec   `json:"spec"`
	Status AutotagV2Status `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AutotagV2List contains a list of AutotagV2s
type AutotagV2List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AutotagV2 `json:"items"`
}

// Repository type metadata.
var (
	AutotagV2_Kind             = "AutotagV2"
	AutotagV2_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AutotagV2_Kind}.String()
	AutotagV2_KindAPIVersion   = AutotagV2_Kind + "." + CRDGroupVersion.String()
	AutotagV2_GroupVersionKind = CRDGroupVersion.WithKind(AutotagV2_Kind)
)

func init() {
	SchemeBuilder.Register(&AutotagV2{}, &AutotagV2List{})
}
