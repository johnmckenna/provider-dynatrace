...
type EmailNotificationInitParameters struct {
...
type EmailNotificationObservation struct {
...
type EmailNotificationParameters struct {
...
// EmailNotificationSpec defines the desired state of EmailNotification
type EmailNotificationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     EmailNotificationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EmailNotificationInitParameters `json:"initProvider,omitempty"`
}

// EmailNotificationStatus defines the observed state of EmailNotification.
type EmailNotificationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EmailNotificationObservation `json:"atProvider,omitempty"`
}
...
// EmailNotification is the Schema for the EmailNotifications API. The resource
...
type EmailNotification struct {
	...
	Spec   EmailNotificationSpec   `json:"spec"`
	Status EmailNotificationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// EmailNotificationList contains a list of EmailNotifications
...
var (
	EmailNotification_Kind             = "EmailNotification"
	EmailNotification_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EmailNotification_Kind}.String()
	EmailNotification_KindAPIVersion   = EmailNotification_Kind + "." + CRDGroupVersion.String()
	EmailNotification_GroupVersionKind = CRDGroupVersion.WithKind(EmailNotification_Kind)
)

func init() {
	SchemeBuilder.Register(&EmailNotification{}, &EmailNotificationList{})
}
