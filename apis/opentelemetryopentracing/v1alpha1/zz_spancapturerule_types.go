...
type SpanCaptureRuleInitParameters struct {
...
type SpanCaptureRuleObservation struct {
...
type SpanCaptureRuleParameters struct {
...
// SpanCaptureRuleSpec defines the desired state of SpanCaptureRule
type SpanCaptureRuleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SpanCaptureRuleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SpanCaptureRuleInitParameters `json:"initProvider,omitempty"`
}

// SpanCaptureRuleStatus defines the observed state of SpanCaptureRule.
type SpanCaptureRuleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SpanCaptureRuleObservation `json:"atProvider,omitempty"`
}
...
// SpanCaptureRule is the Schema for the SpanCaptureRules API. The resource
...
type SpanCaptureRule struct {
	...
	Spec   SpanCaptureRuleSpec   `json:"spec"`
	Status SpanCaptureRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SpanCaptureRuleList contains a list of SpanCaptureRules
type SpanCaptureRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SpanCaptureRule `json:"items"`
}

// Repository type metadata.
var (
	SpanCaptureRule_Kind             = "SpanCaptureRule"
	SpanCaptureRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SpanCaptureRule_Kind}.String()
	SpanCaptureRule_KindAPIVersion   = SpanCaptureRule_Kind + "." + CRDGroupVersion.String()
	SpanCaptureRule_GroupVersionKind = CRDGroupVersion.WithKind(SpanCaptureRule_Kind)
)

func init() {
	SchemeBuilder.Register(&SpanCaptureRule{}, &SpanCaptureRuleList{})
}
